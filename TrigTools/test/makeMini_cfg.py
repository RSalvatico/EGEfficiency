...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/eos/cms/store/group/phys_egamma/tnpTuples/rverma/crab_CMSHLT_3313/EGamma0/crab_CMSHLT_3313/240823_124805/0000/test_RAW2DIGI_L1REPACK_HLT_234.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('stepMINI nevts:-1'),
...
process.MINIAODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:stepMINI.root'),
...
process.patTrigger.processName = "MYHLT"
